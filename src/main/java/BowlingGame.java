...
public class BowlingGame {
    ...
    public int computeSumWithRawData(String rawScores) {

        return calculateSum(convertListToArray(convertRawScoreToList(rawScores)));
    }
    ...
    List<Integer> convertRawScoreToList(String rawScores) {
    ...
    private int[] convertListToArray(List<Integer> scoreList) {
